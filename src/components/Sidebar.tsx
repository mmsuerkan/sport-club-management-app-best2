...
export const Sidebar: React.FC<SidebarProps> = ({ isExpanded, onExpandedChange }) => {
  ...
  const menuItems: MenuItem[] = [
    { icon: <Home size={20} />, name: t.dashboard.title, path: '/dashboard' },
    ...
    { icon: <Clock size={20} />, name: t.attendanceRecords.title, path: '/attendance-records' },
    {
      ...
      path: '/payments',
      subItems: [
        { name: t.payments.overview, path: '/payments/overview' },
        { name: t.payments.history, path: '/payments/history' },
        { name: t.payments.add, path: '/payments/add' }
      ]
    },
    {
      icon: <Wallet size={20} />,
      ...
      path: '/finance',
      subItems: [
        { name: t.finance.overview, path: '/finance/overview' },
        { name: t.finance.expenses, path: '/finance/expenses' },
        { name: t.finance.budget, path: '/finance/budget' },
